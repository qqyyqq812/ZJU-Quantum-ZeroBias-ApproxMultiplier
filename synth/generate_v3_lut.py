...
print("[*] Generating Verilog Testbench for 65536 exact-approx combinations...")
...
tb_path = '/tmp/tb_v3_lut.v'
sim_exec = '/tmp/sim_v3_lut'
v3_verilog_path = '/home/qq/projects/approx-multiplier/synth/rtl/KMap_V3_Final_SchemeD.v'
...
raw_csv_path = '/tmp/raw_v3_lut.csv'
with open(raw_csv_path, 'w') as f:
    f.write('\n'.join(csv_lines))

print(f"[*] Processing data and calculating abs_error & rel_error without Pandas...")

final_csv_path = '/home/qq/projects/approx-multiplier/synth/v3_lut.csv'
